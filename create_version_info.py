...
def main(argv: list[str]) -> int:
    if len(argv) != 4:
        print("Usage: VersionGenerator <output_path> <AssemblyName> <AssemblyGuid> <about_xml_path>")
    ...
    lines.append(f"    public const string Version = @\"{_escape_csharp_verbatim_string(version)}\";")
    lines.append(f"    public const string VersionLong = @\"{_escape_csharp_verbatim_string(version_long)}\";")
    lines.append(f"    public const string VersionGit = @\"{_escape_csharp_verbatim_string(describe)}\";")
    lines.append(f"    public const string VersionSuffix = @\"{_escape_csharp_verbatim_string(version_suffix)}\";")
    lines.append(f"    public const string AssemblyName = @\"{_escape_csharp_verbatim_string(argv[1])}\";")
    lines.append(f"    public const string AssemblyGuid = @\"{_escape_csharp_verbatim_string(argv[2])}\";")
